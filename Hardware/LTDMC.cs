...
namespace PCBasedController.Hardware
{
    public partial class LTDMC
    {
        ...
        [DllImport("LTDMC.dll", EntryPoint = "dmc_read_outport_ex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern short dmc_read_outport_ex(UInt16 CardNo, UInt16 portno, ref uint status);
